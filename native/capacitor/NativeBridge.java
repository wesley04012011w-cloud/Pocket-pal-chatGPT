...
public final class NativeBridge {
  ...
  public static native boolean nativeGenerateChat(String[] roles,String[] contents,int maxTokens,float temperature,float topP,int topK,float minP,float repeatPenalty,int repeatLastN,long seed,boolean useJinja,boolean enableThinking,String systemPrompt,TokenCallback callback);
}
